<%-- 
    Document   : index
    Created on : 30 Apr, 2019, 9:18:40 PM
    Author     : Adit Jana
--%>
...
<header>
	...
	<section class="about" id="about">
		<div class="container">
			...
			<div class="about-details" data-aos="fade-left" data-aos-delay="600" >
				...
				<p>
					Hey !! I am Adit Jana dcbjsdkbjsb kjscncksjnk ksjsjdn fhfhfgfghffhfh hfthrhrh aadwda wdad wd
					sdsjbsdjbjsdbcjbdjvbjdbvj  badbdbjbsjfeb sjdbsjkd if some one kill somethingg efwfw efef ef
					jsbfbsjbj  ksbijsbijs kbjsjf jbjdsbf of9weh we fb 
		...
		<div class="container">
			...
			<div class="my-skills">
				<div class="skill"  data-aos="fade-in" data-aos-delay="300">
					...
					<h1>Web Desing</h1>
					<p>
						ncskjdnvkjnvkjn dcbjsdkbjsb kjscncksjnk ksjsjdn 
						sdsjbsdjbjsdbcjbdjvbjdbvj  badbdbjbsjfeb sjdbsjkd
					</p>
				</div>
		...
		<div class="container">
			...
			<div class="portfolio-item">
				...
				<div class="portfolio-description" data-aos="fade-left" data-aos-delay="600" >
					...
					<h1>Blog Website</h1>
					<p>
						/jdkjbkebkj ejbsjebf ekjkfskje esksjkjnjnj
						scsjhcjhscbhs edbsejdbje jes  sejjhs jbjdsbf
					</p>
			...
			<div class="portfolio-item">
				<div class="portfolio-description"  data-aos="fade-right" data-aos-delay="900">
					...
					<p>
						/jdkjbkebkj ejbsjebf ekjkfskje esksjkjnjnj drre fdrdgd f
						scsjhcjhscbhs edbsejdbje jes  sejjhs jbjdsbffbfb  fvdfvd
					</p>
					<a href="#" class="cta">View Details</a>
				</div>
				
				<div class="portfolio-img has-margin-right"  data-aos="fade-left" data-aos-delay="1200" >
	...
	<section class="experience" id="experience">
		<div class="container">
			<div class="section-heading">
				<h1>Experience</h1>
				<h6>Some of my work experience</h6>
			</div>
			<div class="timeline"  data-aos="fade-down" data-aos-delay="300" >
				<ul>
					...
					<h1>Google</h1>
					<p>
						ckbjcbks jhdbjbdeh jhdah j jyad  d aduh dddeide 
						kjkjbj wjdwabdbwd wdwjdba djddbjdkebdebd dcbjsdkbjsb
					</p>
					</li>
					...
					<li class="date" data-date="2004 - 2007">
					<h1>Microsoft</h1>
					<p>
						ckbjcbks jhdbjbdeh jhdah j jyad  d aduh dddeide 
						kjkjbj wjdwabdbwd wdwjdba djddbjdkebdebd dcbjsdkbjsb
	...
	<section class="contact" id="contact">
		<div class="container">
			...
			<form action="display"  method="" data-aos="fade-down" data-aos-delay="300" >
				...
				<textarea name="subject"  cols="10" rows="10"></textarea>
